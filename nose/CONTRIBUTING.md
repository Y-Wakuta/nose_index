...
Fork the project [on GitHub](https://github.com/michaelmior/NoSE) and check out your
copy locally.

```text
$ git clone git@github.com:username/NoSE.git
$ cd NoSE
$ git remote add upstream git://github.com/michaelmior/NoSE.git
```
...
Go to `https://github.com/yourusername/NoSE` and select your feature branch.
